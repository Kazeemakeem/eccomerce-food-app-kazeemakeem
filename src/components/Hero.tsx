...
const Hero = () => {
  return (
    <div className='max-w-[120rem] mx-auto p-4'>
      ...
      <img className='w-full h-[35rem] max-h-[35rem] object-cover' src='https://images.pexels.com/photos/2983101/pexels-photo-2983101.jpeg?auto=compress&cs=tinysrgb&w=600' alt='Hero-image.jpg'/>
    </div>
  )
}
export default Hero
